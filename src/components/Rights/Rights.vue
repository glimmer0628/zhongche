<template>
  <div class="rights">
    <ul class="rightsTop">
      <li @click="switchNews(5)"><div :class="{'active':changetext[0]}" class="textContainer">工作制度</div></li>
      <li @click="switchNews(6)"><div :class="{'active':changetext[1]}" class="textContainer">法规宣教</div></li>
      <li @click="switchNews(7)"><div :class="{'active':changetext[2]}" class="textContainer">我要留言</div></li>
    </ul>
